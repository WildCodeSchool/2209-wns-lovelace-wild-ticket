...
import { DASHBOARD_RESTAURANT } from "../../../pages/paths";
import { MAX_ICON_PARAMS_TYPE, MIN_ICON_PARAMS_TYPE } from "../../utils";
import "./SVGIconRestaurant.scss";

export default function SVGIconRestaurant({
  iconMaxParams,
  iconMinParams,
}: {
  ...
  return (
    ...
    >
      <svg
        ...
        width={
          isMouseOver || location === DASHBOARD_RESTAURANT
            ? iconMaxParams.width
            : iconMinParams.width
        }
        viewBox="0 0 512 512"
