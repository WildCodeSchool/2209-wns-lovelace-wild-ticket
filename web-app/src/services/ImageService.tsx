export function validateAndConvertImageToBase64(file: any, callback: any) {
    ...
    image.onload = () => {
      ...
      if (file.size > maxSize) {
        callback("La taille de l'image dépasse la limite autorisée.(1Mo)", null);
        return;
      }
    ...
    image.onerror = () => {
      callback("Une erreur s'est produite lors du chargement de l'image.", null);
    };
  }