...
const restaurantToUpperCase = (restaurantName: string) => {
...
export const exportTickets = (
  ...
  restaurantName = restaurantToUpperCase(restaurantName);
  ...
  switch (type) {
    ...
    case "xlsx":
      ...
      blob = new Blob([write(workbook, { type: "array", bookType: "xlsx" })], {
